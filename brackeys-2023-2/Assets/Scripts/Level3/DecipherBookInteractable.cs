...
public class DecipherBookInteractable : MonoBehaviour, IInteractable
{
    [SerializeField]
    ...
    {
        if (state == Level3Manager.Level3State.FOUND_MUSIC_SHEETS)
        {
    ...
    void IInteractable.ClickInteract()
    {
        ...
        _Level3Manager.SetFoundDecipherBook();
        Destroy(gameObject);
    }
}
